...
static PyMethodDef module_methods[] = {
    {"enable",
     (PyCFunction)(void *)faulthandler_py_enable, METH_VARARGS|METH_KEYWORDS,
    ...
    {"dump_traceback",
     (PyCFunction)(void *)faulthandler_dump_traceback_py, METH_VARARGS|METH_KEYWORDS,
     PyDoc_STR("dump_traceback(file=sys.stderr, all_threads=True): "
               "dump the traceback of the current thread, or of all threads "
               "if all_threads is True, into file")},
#ifdef FAULTHANDLER_LATER
    {"dump_traceback_later",
     (PyCFunction)(void *)faulthandler_dump_traceback_later, METH_VARARGS|METH_KEYWORDS,
...
#ifdef FAULTHANDLER_USER
    {"register",
     (PyCFunction)(void *)faulthandler_register_py, METH_VARARGS|METH_KEYWORDS,
     PyDoc_STR("register(signum, file=sys.stderr, all_threads=True, chain=False): "
               "register a handler for the signal 'signum': dump the "
               "traceback of the current thread, or of all threads if "
               "all_threads is True, into file")},
    {"unregister",
     (PyCFunction)(void *)faulthandler_unregister_py, METH_VARARGS|METH_KEYWORDS,
