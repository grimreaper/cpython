...
_ssl_Certificate_bundle_from_file_impl(PyTypeObject *type, PyObject *path,
                                       PyObject *password, int format)
/*[clinic end generated code: output=0ec6e833eaa14ab3 input=3bd2f194e655cadd]*/
{
    PyObject *certs;
    BIO *bio;
    PySSLPasswordInfo pw_info = { NULL, NULL, NULL, 0, 0 };
...
_ssl_Certificate_bundle_from_buffer_impl(PyTypeObject *type,
                                         Py_buffer *buffer,
                                         PyObject *password, int format)
/*[clinic end generated code: output=f5fe00531c2cedcf input=b1d230a286efa74f]*/
{
    PyObject *certs;
    BIO *bio;
    PySSLPasswordInfo pw_info = { NULL, NULL, NULL, 0, 0 };
...
certificate_repr(PySSLCertificate *self)
{
    ...
    osubject = _x509name_oneline(X509_get_subject_name(self->cert));
    if (osubject == NULL)
        return NULL;
