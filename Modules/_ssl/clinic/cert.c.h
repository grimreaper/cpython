...
"bundle_from_file($type, /, path, *, password=None, format=FILETYPE_PEM)\n"
"--\n"
"\n");

#define _SSL_CERTIFICATE_BUNDLE_FROM_FILE_METHODDEF    \
    {"bundle_from_file", (PyCFunction)_ssl_Certificate_bundle_from_file, METH_FASTCALL|METH_KEYWORDS|METH_CLASS, _ssl_Certificate_bundle_from_file__doc__},
...
_ssl_Certificate_bundle_from_file(PyTypeObject *type, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    PyObject *return_value = NULL;
    static const char * const _keywords[] = {"path", "password", "format", NULL};
    static _PyArg_Parser _parser = {"O&|$Oi:bundle_from_file", _keywords, 0};
    PyObject *path;
    PyObject *password = Py_None;
    int format = PY_SSL_FILETYPE_PEM;
    ...
    return_value = _ssl_Certificate_bundle_from_file_impl(type, path, password, format);
...
"bundle_from_buffer($type, /, buffer, *, password=None,\n"
"                   format=FILETYPE_PEM)\n"
"--\n"
"\n");

#define _SSL_CERTIFICATE_BUNDLE_FROM_BUFFER_METHODDEF    \
    {"bundle_from_buffer", (PyCFunction)_ssl_Certificate_bundle_from_buffer, METH_FASTCALL|METH_KEYWORDS|METH_CLASS, _ssl_Certificate_bundle_from_buffer__doc__},
...
_ssl_Certificate_bundle_from_buffer(PyTypeObject *type, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    PyObject *return_value = NULL;
    static const char * const _keywords[] = {"buffer", "password", "format", NULL};
    static _PyArg_Parser _parser = {"y*|$Oi:bundle_from_buffer", _keywords, 0};
    Py_buffer buffer = {NULL, NULL};
    PyObject *password = Py_None;
    int format = PY_SSL_FILETYPE_PEM;
    ...
    return_value = _ssl_Certificate_bundle_from_buffer_impl(type, &buffer, password, format);
...
/*[clinic end generated code: output=7834fc53d1ff495e input=a9049054013a1b77]*/
